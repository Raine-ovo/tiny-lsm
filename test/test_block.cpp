...
TEST_F(BlockTest, EncodeTest) {
  ...
  block.add_entry("orange", "orange3", 0, false);
  block.add_entry("orange", "orange2", 0, false);
  block.add_entry("orange", "orange1", 0, false);
  ...
  // 指定事务id查询
  // EXPECT_EQ(decoded->get_value_binary("orange", 0).value(), "orange1");
  // EXPECT_EQ(decoded->get_value_binary("orange", 0).value(), "orange2");
  // EXPECT_EQ(decoded->get_value_binary("orange", 0).value(), "orange3");
}
